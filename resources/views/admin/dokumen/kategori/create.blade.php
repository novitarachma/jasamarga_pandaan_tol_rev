...
<div class="col-sm-6">
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active">Create Kategori Dokumen</li>
    </ol>
</div>
@endsection
...
<div class="container-fluid">
    <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">Add Kategori Dokumen</h3>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" placeholder="Input Kategori Dokumen">
                            @error('name')
