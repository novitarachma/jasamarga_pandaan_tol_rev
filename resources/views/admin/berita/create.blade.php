...
<div class="container-fluid">
    <div class="card card-default">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form method="post" action="{{ route('berita.store') }}" id="myForm" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('paragraf1') is-invalid @enderror" rows="3"
                                id="paragraf1" name="paragraf1" placeholder="Enter Paragraph 1"></textarea>
                            @error('paragraf1')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('paragraf2') is-invalid @enderror" rows="3"
                                id="paragraf2" name="paragraf2" placeholder="Enter Paragraph 2"></textarea>
                            @error('paragraf2')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('paragraf3') is-invalid @enderror" rows="3"
                                id="paragraf3" name="paragraf3" placeholder="Enter Paragraph 3"></textarea>
                            @error('paragraf3')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
