    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <a class="btn btn-success" href="{{ route('berita.create') }}">Add Berita</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form onsubmit="return confirm('Move data to trash?')"
                                        action="{{ route('berita.destroy',['berita'=>$value->id]) }}" method="POST">
                                        <a class="btn btn-primary" href="{{ route('berita.edit',$value->id) }}">Edit</a>
                                        @csrf
                                        @method('DELETE')
